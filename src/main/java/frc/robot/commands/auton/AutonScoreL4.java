...
public class AutonScoreL4 extends SequentialCommandGroup {
  ...
  public AutonScoreL4(SwerveSubsystem swerveSubsystem, Elevator elevator, Claw claw) {
    // Use addRequirements() here to declare subsystem dependencies.
    addRequirements(swerveSubsystem, elevator, claw);
    addCommands(new ParallelCommandGroup(
            elevator.moveToL4(), 
            Commands.waitSeconds(0.2).andThen(claw.moveClawToL4Command())),
        Commands.waitSeconds(1),
        new LineUpL4(swerveSubsystem, true),
        claw.scoreL4(),
